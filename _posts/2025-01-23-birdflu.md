...
<div style="width: 100%; height: 600px;">
    <iframe src="{{ site.baseurl }}/datavis/outbreak_map.html" style="width: 100%; height: 100%; border: none;"></iframe>
</div>
<div class='col three caption'> Interactive visualization using python, plotly.js, by [@kenzasam](https://github.com/kenzasam/kenzascience/datavis), code:[github](https://github.com/kenzasam/kenzascience/) , data source:[USDA](https://www.aphis.usda.gov/livestock-poultry-disease/avian/avian-influenza/hpai-detections/commercial-backyard-flocks) </div>
